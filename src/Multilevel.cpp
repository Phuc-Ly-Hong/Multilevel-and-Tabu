...
void run_all_datasets() {
    ...
    for (const auto& dataset_path : datasets) {
        ...
        cout << "\n📋 RESULT:" << endl;
        cout << "Makespan: " << best_solution.makespan << " min" << endl;
        cout << "Drone violation: " << best_solution.drone_violation << " min" << endl;
        cout << "Waiting violation: " << best_solution.waiting_violation << " min" << endl;
        cout << "Fitness: " << best_solution.fitness << endl;
        cout << "Feasible: " << (best_solution.is_feasible ? "✅ YES" : "❌ NO") << endl;
...
int main(int argc, char* argv[]) {
    ...
    if (argc > 1) {
        ...
        cout << "\n🚛 Vehicles: 3 trucks (" << TRUCK_SPEED << " m/min) + 3 drones (" << DRONE_SPEED << " m/min, 120min limit)" << endl;
